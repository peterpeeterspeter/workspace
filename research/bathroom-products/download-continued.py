...
more_urls = {
    'faucets': [
        ...
        'https://images.unsplash.com/photo-1585704032863-9208c82588a0?w=800',
        'https://images.unsplash.com/photo-1584622650111-996317b8d101?w=800',
        'https://images.unsplash.com/photo-1585704032956-8a9c5d72f8f0?w=800',
        'https://images.unsplash.com/photo-1604762584865-43b6e2b9b5d5?w=800',
        'https://images.unsplash.com/photo-1585704032956-c3400ca199e7?w=800',
    ],
    'showers': [
        'https://images.unsplash.com/photo-1552321554-5fefe8c9ef14?w=800',
        'https://images.unsplash.com/photo-1600566753086-00f18fb6b3ea?w=800',
        'https://images.unsplash.com/photo-1584622650245-5a18e8c1f6b0?w=800',
...
downloaded = 0
for cat, urls in more_urls.items():
